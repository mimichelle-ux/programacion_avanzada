...
promociones = [
    Promocion("PROMO1", "Promocion 1", 10, "2026-05-01"),
    Promocion("PROMO2", "Promocion 2", 15, "2026-05-02"),
    Promocion("PROMO3", "Promocion 3", 20, "2026-05-03"),
    Promocion("PROMO4", "Promocion 4", 25, "2026-05-04"),
    Promocion("PROMO5", "Promocion 5", 30, "2026-05-05"),
    Promocion("PROMO6", "Promocion 6", 35, "2026-05-06"),
    Promocion("PROMO7", "Promocion 7", 40, "2026-05-07"),
    Promocion("PROMO8", "Promocion 8", 45, "2026-05-08"),
    Promocion("PROMO9", "Promocion 9", 50, "2026-05-09"),
    Promocion("PROMO10", "Promocion 10", 55, "2026-05-10")
]
...
funciones[0].asientosOcupados = ["A2"] 
print("Usuario:", usuarios[0].nombre, "(Puntos de fidelidad:", usuarios[0].puntosFidelidad, ")")
print("\n")
print("Funcion:", funciones[0].pelicula.titulo, "| Sala:", funciones[0].sala.tipo.name)
print("\n")
print("Asientos seleccionados : A1, A2, B5")

if "A2" in funciones[0].asientosOcupados:
    print("El asiento A2 ya está ocupado.")
print("\n")
print("Seleccione los asientos: A1, A3, B5")
funciones[0].asientosOcupados.append("A1")
funciones[0].asientosOcupados.append("A3")
funciones[0].asientosOcupados.append("B5")
print("Asientos A1, A3, B5 seleccionados")
print("\n")
print("Monto:", funciones[0].precioBase * 3)

print("\n")
reservas[0].aplicarPromocion(promociones[0])
...
print("\n productos vendidos:")
zonas[0].venderProducto ("Palomitas")
zonas[0].venderProducto("Refresco")
zonas[0].venderProducto("Pizza")  

print("\nVALIDACION DE FUNCIONES FINALIZADO")
